...
export const metadata = createMetadata({
  title: 'About',
  description: 'Learn about the team building Orcaworks and the mission behind our customer support platform.',
  path: '/about',
})
  ...
  return (
    <>
      ...
      <HeroLeftAlignedWithPhoto
        id="hero"
        eyebrow={<Eyebrow variant="brand">About us</Eyebrow>}
