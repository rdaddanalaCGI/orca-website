...
export const staticRoutes: StaticRoute[] = [
  ...
  { path: '/solutions/legal', changeFrequency: 'monthly', priority: 0.5 },
  ...
  { path: '/solutions/specialty-commercial-lending-finance', changeFrequency: 'monthly', priority: 0.5 },
  { path: '/solutions/facilities-management', changeFrequency: 'monthly', priority: 0.5 },
