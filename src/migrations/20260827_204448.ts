...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_form_submissions_submission_type" AS ENUM('contact', 'demo', 'partner');
  CREATE TYPE "public"."enum_form_submissions_status" AS ENUM('new', 'processing', 'completed', 'spam');
  CREATE TABLE "posts" (
  ...
  CREATE TABLE "press_releases" (
  	...
  	"source_url" varchar,
  	"hero_image_id" integer,
  	"status" "enum_press_releases_status" DEFAULT 'draft' NOT NULL,
  	"seo_title" varchar,
  	"seo_description" varchar,
  	"og_image_id" integer,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  ALTER TABLE "press_releases" ADD CONSTRAINT "press_releases_hero_image_id_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "press_releases" ADD CONSTRAINT "press_releases_og_image_id_media_id_fk" FOREIGN KEY ("og_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "press_releases_hero_image_idx" ON "press_releases" USING btree ("hero_image_id");
  CREATE INDEX "press_releases_og_image_idx" ON "press_releases" USING btree ("og_image_id");
